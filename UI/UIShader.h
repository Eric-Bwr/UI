...
const char* UICircularShaderFragment = "#version 430 core\n"
                                       ...
                                       "\n"
                                       "    float ODC = smoothstep(diameters.x, diameters.x - 0.02, distance);\n"
                                       "    float IDC = smoothstep(diameters.y, diameters.y + 0.02, distance);\n"
                                       "    float circleAlpha = ODC * IDC;\n"
                                       "    float circleAngle = (atan(uv.x, uv.y) + M_PI) / (M_PI * 2);\n"
                                       "    float blendStrength = 0.01;\n"
                                       "    if(circleAlpha > 0.000001){\n"
                                       "        float alpha1 = step(arcs.x, circleAngle) * (1.0 - smoothstep(arcs.y, arcs.y + blendStrength, circleAngle));\n"
                                       "        float alpha2 = smoothstep(arcs.y - blendStrength, arcs.y, circleAngle) * (1.0 - smoothstep(arcs.z, arcs.z + blendStrength, circleAngle));\n"
                                       "        float alpha3 = smoothstep(arcs.z - blendStrength, arcs.z, circleAngle) * istep(arcs.w, circleAngle);\n"
                                       ...
                                       "    }\n"
                                       "\n"
                                       "    ODC = smoothstep(diameters.z, diameters.z - 0.02, distance);\n"
                                       "    IDC = smoothstep(diameters.w, diameters.w + 0.02, distance);\n"
                                       "    circleAlpha = ODC * IDC;\n"
